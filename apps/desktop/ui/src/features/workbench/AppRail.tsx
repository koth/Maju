  ...
  return (
    <aside className="app-rail" aria-label="Application navigation">
      <div className="app-rail-top">
        ...
        <nav className="app-rail-nav" aria-label="Primary destinations">
          <button
            type="button"
            ...
            aria-label={sidebarCollapsed ? "Show Threads panel" : "Hide Threads panel"}
          >
            ...
            <span className="app-rail-label">Threads</span>
          </button>
        </nav>
      </div>
