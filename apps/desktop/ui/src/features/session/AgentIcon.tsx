...
/**
 * DeepSeek whale in the brand blue. Path from the Simple Icons brand set
 * (`deepseek`), which is the accurate silhouette — the previous hand-drawn
 * approximation read as an anonymous blob at badge size. Uses the default
 * nonzero fill rule, so do not add `fillRule="evenodd"`: it would punch holes
 * through the overlapping subpaths.
 */
