...
use workspace_model::{
    ...
    ChangeSetSummary, ChatMessage, DiffHunk, DiffLineKind, DiffQuality, FileChangeRecord,
    FileChangeSummary, FileChangeType, GetChangeSetFileDiffRequest, ListChangeSetFilesRequest,
    ListChangeSetsRequest, MessageRole, SessionConfigSource, SessionFileChange, SessionListItem,
    SessionStatus, TimelineItem, ToolDiffPreview, ToolInvocation, ToolLogEntry, ToolStatus,
    TurnFileChanges, UserPromptContent,
};
...
use diff_utils::{
    ...
    sanitize_session_file_changes, tool_diff_hunks_for_detected_write, tool_event_hint_paths,
    tool_hunks_for_tracker_update,
};
#[cfg(test)]
use diff_utils::{tool_diff_hunks, tool_diff_hunks_for_tracker_change};
